...
const Feedback = () => {
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="card-body pb-4 grid justify-center items-center">
                {/* Feedback */}
                <div className="form-control">
                    <label className="label">
                        <span className="label-text">Feedback</span>
                    </label>
                    <textarea type="text" {...register("feedback", { required: true })}
                ...
                <div className="form-control mt-6">
                    <input className="sports-button btn-wide" type="submit" value="Send Feedback" />
                </div>
            </form>
